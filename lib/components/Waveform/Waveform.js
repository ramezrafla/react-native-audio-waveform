...
export const Waveform = forwardRef((props, ref) => {
    ...
    playbackSpeed = 1.0, candleSpace = 2, candleWidth = 5, containerStyle = {}, waveColor, scrubColor, onPlayerStateChange, onRecorderStateChange, onPanStateChange = () => { }, onError, onCurrentProgressChange = () => { }, candleHeightScale = 3, onChangeWaveformLoadState, } = props;
    ...
    const { extractWaveformData, preparePlayer, getDuration, seekToPlayer, playPlayer, stopPlayer, pausePlayer, onCurrentDuration, onDidFinishPlayingAudio, onCurrentRecordingWaveformData, setPlaybackSpeed, } = useAudioPlayer();
